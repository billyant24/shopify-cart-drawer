...
<div class="cart-container">
  ...
  <div class="cart-body">
    ...
    <div class="right-column">
      <div style="margin-bottom: 2rem;">
        <CountdownTimer minutesCountDown={30} />
      </div>
      ...
      <!-- <div style="margin: 2rem 0;">
				<CountdownTimer minutesCountDown={10} />
			</div> -->
  ...
  <div id="cart-footer" class="cart-footer">
    <div
      style="font-size: 1.375rem; font-weight: 600; margin-bottom: 3rem; text-align: left; "
    >
      You may also like
    </div>
    <UpsellItems />
  ...
  <div class="cart-experience">
    <div class="rate-experience">
      <div
        class="sf-footer__right w-full flex flex-wrap justify-center md:justify-start lg:justify-center items-center lg:w-auto"
      >
        <div class="payment-icons">
          <ul class="list-payment-ul-icons">
            <li class="m-2.5">
              <svg
                ...
                ><title id="pi-visa">Visa</title><path
                  opacity=".07"
            ...
            <li class="m-2.5">
              <svg
                ...
                ><title id="pi-master">Mastercard</title><path
                  opacity=".07"
                  d="M35 0H3C1.3 0 0 1.3 0 3v18c0 1.7 1.4 3 3 3h32c1.7 0 3-1.3 3-3V3c0-1.7-1.4-3-3-3z"
                /><path
                  fill="#fff"
            ...
            <li class="m-2.5">
              <svg
                ...
                ><title id="pi-american_express">American Express</title><g
                  fill="none"
                  ><path
                    fill="#000"
            ...
            <li class="m-2.5">
              <svg
                ...
                ><title id="pi-paypal">PayPal</title><path
                  opacity=".07"
                  d="M35 0H3C1.3 0 0 1.3 0 3v18c0 1.7 1.4 3 3 3h32c1.7 0 3-1.3 3-3V3c0-1.7-1.4-3-3-3z"
                /><path
                  fill="#fff"
            ...
            <li class="m-2.5">
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                ><title id="pi-discover">Discover</title><path
                  fill="#000"
                  opacity=".07"
                  d="M35 0H3C1.3 0 0 1.3 0 3v18c0 1.7 1.4 3 3 3h32c1.7 0 3-1.3 3-3V3c0-1.7-1.4-3-3-3z"
                /><path
    ...
    <div class="powered-by">
      🛒 Powered by <a href="https://www.google.com/" target="_blank">
        Slick Cart</a
      >
    </div>
  </div>
